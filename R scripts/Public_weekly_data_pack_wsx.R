...
total_cases_reported_plot <- ggplot(area_x_df_1,
  ...
  scale_x_date(date_labels = "%b %d",
               breaks = seq.Date(max(area_x_df_1$Date) -(52*7), max(area_x_df_1$Date), by = 2),
